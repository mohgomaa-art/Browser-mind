...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-border-default bg-bg-panel font-medium [&>tr]:last:border-b-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border-default transition-colors hover:bg-bg-elevated/50 data-[state=selected]:bg-bg-elevated",
      className,
    )}
    {...props}
  />
